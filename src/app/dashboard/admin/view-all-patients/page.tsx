// src/app/dashboard/admin/view-all-patients/page.tsx
"use client";
...
import { Eye, AlertTriangle, ArrowLeft, Users, ShieldCheck } from 'lucide-react';
...
export default function AdminViewAllPatientsPage() {
  ...
  useEffect(() => {
    ...
    async function fetchAllPatients() {
      ...
      try {
        ...
        console.error("Error fetching all patients for admin:", err);
        ...
        if (err.code === "unavailable" || err.message?.includes("client is offline")) {
          specificError = "Could not load patients: Database is offline. Please check your internet connection.";
            ...
            specificError = "Could not load patients: Permission denied. Please check Firestore security rules for admin access.";
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-3xl font-headline">All Patient Records (Admin View)</h1>
      </div>

      <Card className="shadow-xl">
        <CardHeader>
          <CardTitle className="text-2xl font-headline">System-Wide Patient List</CardTitle>
          <CardDescription className="font-body">
            Browse all patient records registered in the InfantCare system.
          </CardDescription>
        </CardHeader>
        <CardContent>
          {error ? (
            ...
            <p className="text-muted-foreground text-center py-4">No patient records found in the system.</p>
          ) : (
            <Table>
              <TableHeader>
                <TableRow>
